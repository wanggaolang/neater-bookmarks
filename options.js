...
function init() {
	...
	$('resetText').innerHTML = chrome.i18n.getMessage('resetText');
	...
	var authorName = '<a href="mailto:neaterbookmarks@gmail.com?subject=Neater Bookmarks&body=%0d%0dSent from Neater Bookmarks Options page">Evan Shultz</a>';
	var neatBookmarksGithub = '<a href="http://github.com/cheeaun/neat-bookmarks">Neat Bookmarks</a>';
	var authorNameOriginal = '<a href="http://twitter.com/cheeaun">Lim Chee Aun</a>';
	$('optionsFooterText').innerHTML = chrome.i18n.getMessage('optionsFooterText', [authorName, neatBookmarksGithub, authorNameOriginal]);
};
